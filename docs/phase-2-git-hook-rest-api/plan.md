...
- [x] **Step 1: Write failing tests for get_latest_commit_hash and get_latest_timestamp**
...
- [x] **Step 3: Implement get_latest_commit_hash and get_latest_timestamp**
...
- [x] **Step 1: Write failing test for incremental git ingest**
...
- [x] **Step 3: Add since_commit parameter to parse_git_history**
...
- [x] **Step 4: Add incremental parameter to handle_ingest**
...
- [x] **Step 1: Write failing test for integrations config**
...
- [x] **Step 3: Add integration dataclasses and parsing to config.py**
...
- [x] **Step 1: Write failing test for Jira parsing**
...
- [x] **Step 3: Implement Jira parser**
...
- [x] **Step 1: Write failing test for Confluence parsing**
...
- [x] **Step 3: Implement Confluence parser**
...
- [x] **Step 1: Add atlassian-python-api dependency**
...
- [x] **Step 2: Write failing test for sync handler**
...
- [x] **Step 4: Implement sync handler**
...
- [x] **Step 1: Add deview_sync tool to server.py**
...
- [x] **Step 1: Add typer dependency and script entry point**
...
- [x] **Step 2: Write failing test for CLI**
...
- [x] **Step 1: Write failing test for hook commands**
...
- [x] **Step 3: Add hook subcommand to CLI**
...
- [x] **Step 1: Update deview_ingest MCP tool**
...
- [x] **Step 1: Update config.yaml.example with integrations section**
...
- [x] **Step 1: Write integration test covering end-to-end flow**
